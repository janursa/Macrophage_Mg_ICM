...
%% 
% 158 -> pIKK; 176 -> NFKB_n
m.Species(158).InitialAmount = 100;
...
% o2=ics(78);
% m.Species(78).InitialAmount=o2/21*3; %simulate 3 percent oxygen
set(cs, 'StopTime', 1500); %set simulation time (in minutes)
[t,out] = sbiosimulate(m); %simulate model
h1=out(:,127); %get simulated total cellular hif1a expression
